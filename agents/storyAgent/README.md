...
export GOOGLE_AI_STUDIO_MODEL="gemini-2.5-flash"  # Optional, defaults to gemini-2.5-flash
```
...
gcloud run deploy story-agent \
  ...
  --platform managed \
  --region us-central1 \
  --set-env-vars GOOGLE_CLOUD_PROJECT=your-project-id,GOOGLE_AI_STUDIO_API_KEY=your-api-key,GOOGLE_AI_STUDIO_MODEL=gemini-2.5-flash
```
